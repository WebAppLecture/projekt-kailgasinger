        ...
        switch (move) {
            ...
            case "Freeze":
                ...
                for (let i = 0; i<=counter; i++) {
                    this.attackAnims.push( new AttackAnim(xStart+55*Math.random(), yStart-50+45*Math.random(), 10+counter/3*i, 10+counter/3*i, "rgba("+130+Math.random()*80+","+(80+Math.random()*30)+", 16,"+(0.5+Math.random()*0.5)+")", vxStart*2+Math.random(), 4*vyStart+Math.random(), "freeze.png", "Freeze", vxStart, vyStart));
